...
- **Intro to MongoDB** – 2025
- **IBM SkillsBuild AI Fundamentals** – 2025
- **DataCamp: Exploratory Data Analysis in Python** – 2025
...
- Scraped and analyzed 1,000+ customer reviews using Python
- Built a predictive model (85% accuracy) to identify purchase drivers
- Delivered insights in a stakeholder-ready report

### 🏦 Commonwealth Bank Data Engineering Simulation – Forage
- Designed a data pipeline to aggregate and anonymize customer data
- Proposed a social media analytics strategy using structured databases

### 🧮 Deloitte Australia Analytics Simulation – Forage
- Created Tableau dashboard to visualize financial anomalies
- Improved data quality by 30% through Excel-based cleaning
...
- 📧 Email: michelle.galinsky23@gmail.com  
- 🔗 GitHub: [github.com/mgalinsky23](https://github.com/mgalinsky23)  
- 💼 LinkedIn: [linkedin.com/in/michelle-galinsky](https://linkedin.com/in/michelle-galinsky)
